 ...
 */
double __cdecl __IEEE854_ACOS128F_C64F(double _X)
{
    double x = _X;
    double a, z, r, w, p, q, s, t, f2;
    ...
    {
        return std::numeric_limits<double>::quiet_NaN(); // arccos(|x| > 1) is NaN
    }
    ...
    if (a < 0.5L)
    {
        ...
        r = p / q;
        if (x < 0.0L) {r = Acos04375Complementary - r;}
        else {r = Acos04375 + r;}
        return r;
    }
    ...
    if (a < 0.625L)
    {
        ...
        if (x < 0.0L) {r = Acos05625Complementary - p / q;}
        else {r = Acos05625 + p / q;}
        return r;
    }
...
double __cdecl arccosd(double x) {return __IEEE854_ACOS128F_C64F(x);}
double __cdecl arcsecd(double x) {return __IEEE854_ACOS128F_C64F(1. / x);}
